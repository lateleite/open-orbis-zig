...
FUNC(sceSlimglRenderServerThreadStart);
FUNC(sceSlimglServerEndClient);
FUNC(sceSlimglServerRegisterShaderBinary);
FUNC(sceSlimglServerRegisterShaderFile);
FUNC(sceSlimglServerSetPolicy);
FUNC(sceSlimglServerSetupGetDomainSocket);
FUNC(sceSlimglServerSetupSocketPairingBy);
FUNC(sceSlimglServerSetupSocketPairingTransport);
FUNC(sceSlimglServerStartClient);
FUNC(sceSlimglServerStartWithSocket);
FUNC(sceSlimglServerWaitRenderThread);
FUNC(sceSlimglStartServer);
